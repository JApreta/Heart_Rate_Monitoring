...
#include "Particle.h"
#line 1 "c:/Users/bdoug/iCloudDrive/UA/513proj/firsttry/Projct/src/Projct.ino"
/*
  513 Group Teresa Pham, Ben Douglas, Judith Antonio
...
#line 15 "c:/Users/bdoug/iCloudDrive/UA/513proj/firsttry/Projct/src/Projct.ino"
...
//Checks to make sure our device is active at the right Timez
bool rightTime(){
...
bool sendData(int r, int o){
    ...
    if(!Particle.publish("toJudith", fullJson)){
      olDatar[cNum] = r;
      olDatao[cNum] = o;
      cNum++;
      return 0;}
